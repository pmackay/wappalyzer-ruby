module WappalyzerRb
  ...
  APPS = {
    ...
    'ActiveEdition' =>                    { cats: [  1 ], meta: { 'generator' => /activedition/i } },
    ...
    'Contensis' =>                        { cats: [  1 ], meta: { 'generator' => /Contensis CMS/i } },
    ...
    'Co-operative Web CME' =>             { cats: [  1 ], meta: { 'generator' => /Co-operative Web CME/i } },
    ...
    'Cuttlefish CMS' =>                   { cats: [  1 ], meta: { 'generator' => /Cuttlefish CMS/i } },
    ...
    'EIBS - EasySite' =>                  { cats: [  1 ], meta: { 'generator' => /EIBS/i } },
    ...
    'GOSS iCM' =>                         { cats: [  1 ], meta: { 'generator' => /GOSS iCM/i } },
    ...
    'Immediacy' =>                        { cats: [  1 ], meta: { 'generator' => /Immediacy/i, 'GENERATOR' => /Immediacy/i } },
    ...
    'iSiteSQL' =>                         { cats: [  1 ], meta: { 'generator' => /iSiteSQL/i } },
    'iWeb' =>                             { cats: [ 20 ], meta: { 'generator' => /iWeb/i } },
    'Jadu' =>                             { cats: [  1 ], meta: { 'generator' => /jadu/i } },
    ...
    'Libertas ECMS' =>                    { cats: [  1 ], meta: { 'generator' => /Libertas ECMS/i } },
    ...
    'SilverStripe' =>                     { cats: [  1 ], meta: { 'generator' => /SilverStripe/i } },
    ...
    'Sitefinity' =>                       { cats: [  1 ], meta: { 'generator' => /Sitefinity/i } },
    ...
    'VerseOne' =>                         { cats: [  1 ], meta: { 'author' => /VerseOne/i } },
    ...
    'Web Labs ContentMaster CMS' =>       { cats: [  1 ], meta: { 'generator' => /Web Labs ContentMaster CMS/i } },
